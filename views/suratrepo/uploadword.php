...
<div class="container" data-aos="fade-up">
    <div class="card alert <?= ((!Yii::$app->user->isGuest && Yii::$app->user->identity->theme == 0) ? 'bg-light' : 'bg-dark text-light') ?>">
        <h1>Upload DRAFT/WORD FILE Surat Internal</h1>
        <div class="row">
            <div class="col-sm-12">
            ...
            <?php if (
                ...
                <div class="mb-3 transparan" style="border-width:0px">
                    <div class="row g-0">
                        ...
                        <div class="col-md-10">
                            <a href="<?= Yii::$app->request->baseUrl . '/surat/internal/word/' . $model->id_suratrepo . '.doc' ?>" class="btn btn-outline-warning"><i class="fas fa-file-word"></i> Klik untuk Mengunduh</a>
                        </div>
                    </div>
                </div>
            <?php elseif (
                ...
                <div class="mb-3 transparan" style="border-width:0px">
                    <div class="row g-0">
                        ...
                        <div class="col-md-10">
                            <a href="<?= Yii::$app->request->baseUrl . '/surat/internal/word/' . $model->id_suratrepo . '.docx' ?>" class="btn btn-outline-warning"><i class="fas fa-file-word"></i> Klik untuk Mengunduh</a>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
