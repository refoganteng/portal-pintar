...
<div class="container" data-aos="fade-up">
    <div class="card alert <?= ((!Yii::$app->user->isGuest && Yii::$app->user->identity->theme == 0) ? 'bg-light' : 'bg-dark text-light') ?>">
        <h1>Upload SIGNED PDF Surat Eksternal</h1>
        <div class="row">
            <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="form-group text-end mb-3">
                <?= Html::submitButton('<i class="fas fa-save"></i> Upload', ['class' => 'btn btn-outline-warning']) ?>
            </div>
            <?php if (!$model->isNewRecord && file_exists(Yii::getAlias('@webroot/surat/eksternal/pdf/' . $model->id_suratrepoeks . '.pdf'))) : ?>
                <br />
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-10">
                            <div id="pdf-container">
                                ...
                                <iframe id="pdf-iframe" src="<?= Yii::getAlias('@web') ?>/surat/eksternal/pdf/<?php echo $model->id_suratrepoeks ?>.pdf" width="100%" height="350px"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
